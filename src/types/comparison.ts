...
/**
 * Comprehensive processed comparison request with resolution metadata
 * Contains all information needed to proceed with or reject a comparison
 */
...
/**
 * Comprehensive data retrieval results for comparison operations
 * Aggregates all switch retrieval results with analysis metadata
 */
export interface ComparisonDataRetrievalResult {
  switchesData: SwitchDataRetrievalResult[];
